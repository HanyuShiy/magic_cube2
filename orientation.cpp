...
void Orientation::rotateXClockwise(const Angle angle)
{
...
void Orientation::rotateYClockwise(const Angle angle)
{
    // Rotates clockwise when viewed from the positive y-axis
...
void Orientation::rotateZClockwise(const Angle angle)
{
